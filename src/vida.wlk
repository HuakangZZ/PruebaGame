...
object vidaRojo inherits Vida(position = game.at(game.width()-11,12)){
	...
	override method image() = listaDeVida.get(rojito.vida())
	
}

object vidaAzul inherits Vida(position = game.at(1,12)){
	...
	override method image() = listaDeVida.get(azulito.vida())
